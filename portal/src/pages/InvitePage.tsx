  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface-sunken p-6">
      <Card className="w-full max-w-md">
        ...
        {token && isLoading && <p className="text-sm text-ink-secondary">Checking your invitation…</p>}

        {token && error && (
          <>
            <h1 className="text-xl font-semibold text-ink">This invitation has expired</h1>
        ...
        {data && (
          <>
            ...
            <div className="mt-6 border-t border-line pt-4">
              <p className="text-sm font-medium text-ink">Don&rsquo;t have the app yet?</p>
