...
export function AnalysisPage() {
  return (
    <PageContainer wide>
      ...
      <p className="mt-1 text-sm text-ink-secondary">How your groups and events are going.</p>

      <div className="mt-8">
        <EmptyState
          headline="Nothing to show yet"
          body="Attendance trends, who's drifted away, and how events ran against their plan will appear here."
        />
      </div>
    </PageContainer>
  );
